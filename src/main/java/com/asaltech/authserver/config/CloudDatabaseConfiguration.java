package com.asaltech.authserver.config;
...
@Configuration
@EnableMongoRepositories("com.asaltech.authserver.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.asaltech.authserver.config.dbmigrations");
